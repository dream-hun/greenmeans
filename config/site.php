...
return [
    ...
    /*
     * Articles. Body blocks are rendered in order: heading, text, or list.
     */
    'posts' => [
        [
            ...
            'body' => [
                ['text' => 'Selecting an air-conditioning system should begin with the space and its actual cooling requirements, not simply the appearance or advertised capacity of a unit.'],
                ['text' => 'A correctly selected system should match how the room or building is used, the conditions in which the equipment will operate, and the installation requirements of the site.'],
                ['heading' => '1. Start With the Size and Use of the Space'],
                ['text' => 'Room size is an important factor, but it is not the only one. A technical assessment may also consider:'],
                ['list' => [
                    'Ceiling height',
                    'Number of occupants',
                ...
                ['text' => 'A meeting room used periodically has different requirements from a busy retail space or a building with multiple independently occupied zones.'],
                ['heading' => '2. Consider the Type of System'],
                ['text' => 'Different applications require different air-conditioning configurations. A straightforward room may be served by an individual air-conditioning unit, while a larger building with multiple zones may benefit from a more centralized or flexible solution such as a VRF system.'],
                ['text' => 'The correct choice depends on the building layout, required level of control, operating pattern, available installation space, and project budget.'],
                ['heading' => '3. Think About Energy Use'],
                ['text' => 'Air-conditioning equipment may operate for many hours, particularly in offices, commercial facilities, hospitality environments, and other frequently occupied spaces. Energy efficiency should therefore be considered during system selection rather than after installation.'],
                ['text' => 'The system should be appropriately sized and configured for the actual load. Installation quality and maintenance also affect how effectively the equipment operates over time.'],
                ['heading' => '4. Plan the Installation Properly'],
                ['text' => 'Even suitable equipment can perform poorly if installation conditions are not properly considered. Planning should address:'],
                ['list' => [
                ...
                ['text' => 'A technical site assessment can identify these issues before installation begins.'],
                ['heading' => '5. Do Not Ignore Maintenance'],
                ['text' => 'Air-conditioning systems require ongoing care. Filters, coils, drainage, electrical components, refrigerant circuits, and other parts may require inspection or servicing depending on the system and operating conditions.'],
                ['text' => 'Preventive maintenance can help identify faults before they develop into larger technical problems and keeps service requirements visible rather than purely reactive.'],
                ['heading' => '6. Work With a Qualified Technical Team'],
                ['text' => 'The process should connect system selection, supply, installation, testing, and maintenance. Green Means Ltd provides HVAC design, equipment supply, installation, maintenance, and repair services, including air-conditioning and VRF solutions.'],
                ['text' => 'For a new installation, replacement, or upgrade, provide the technical team with details about the building, rooms, intended use, existing systems, and expected operating conditions.'],
            ],
        ],
        [
            ...
            'body' => [
                ['text' => 'A Variable Refrigerant Flow system serves several indoor units from a common outdoor unit, varying the flow of refrigerant to match the demand of each area. That makes it suited to buildings where rooms or zones need to be controlled independently.'],
                ['heading' => 'Where VRF Fits'],
                ['text' => 'VRF is typically considered for buildings with multiple rooms or zones that are occupied at different times or to different densities: offices, hospitality facilities, institutional buildings, and mixed-use spaces.'],
                ...
                ['text' => 'Green Means Ltd designs, supplies, and installs VRF systems, and provides maintenance and repair support once the system is operating.'],
            ],
        ],
        [
            ...
            'body' => [
                ['text' => 'Air-conditioning equipment works continuously in conditions that gradually affect its components. Routine inspection keeps those changes visible before they turn into a failure.'],
                ['heading' => 'What Servicing Covers'],
                ['list' => [
                    'Filters and airflow',
                ...
                ['text' => 'How often each item needs attention depends on the system and the conditions it operates in. A unit running long hours in a dusty environment needs a different schedule from one used occasionally.'],
                ['text' => 'Preventive maintenance also keeps service requirements planned rather than reactive, which usually means fewer interruptions and a clearer view of when components will need replacing.'],
            ],
        ],
        [
            ...
            'body' => [
                ['text' => 'An air handling unit moves air through a building and conditions it on the way: filtering it, heating or cooling it, and delivering it to the spaces that need it.'],
                ...
                ['text' => 'Because an air handling unit serves several spaces at once, its specification depends on the layout of the building, the duct routes available, the plant space, and how the served areas are occupied.'],
                ['text' => 'Green Means Ltd supplies and installs air handling units alongside heating systems, air conditioning, and VRF solutions.'],
            ],
        ],
        [
            ...
            'body' => [
                ['text' => 'Indoor and outdoor displays are built for different conditions. Choosing between them starts with where the screen will be installed and who needs to read it.'],
                ['heading' => 'What Changes Outdoors'],
                ['list' => [
                ...
                ['text' => 'Indoors, the emphasis usually shifts to viewing distance, ambient lighting, and how the display fits the room it serves: reception areas, retail floors, meeting rooms, or information points.'],
                ['text' => 'Send us your location, viewing requirements, installation environment, and intended use, and our team will recommend a suitable solution.'],
            ],
        ],
        [
            ...
            'body' => [
                ['text' => 'Most appliance faults announce themselves before they stop the equipment completely. Acting on those signs early usually keeps the repair smaller.'],
                ...
                ['text' => 'A technical diagnosis identifies the cause before parts are replaced, which avoids paying for components that were never the problem.'],
                ['text' => 'Our service centre covers mobile phones, televisions, refrigerators, air conditioners, and other supported electronic appliances.'],
            ],
        ],
        [
            ...
            'featured' => false,
            'image' => 'post-commercial-hvac-planning',
            ...
            'body' => [
                ['text' => 'Commercial buildings rarely behave as one space. Different areas are occupied at different times, by different numbers of people, for different purposes, and the HVAC plan has to reflect that.'],
                ['heading' => 'What the Plan Should Address'],
                ['list' => [
                ...
                ['text' => 'Decisions made at this stage determine how the building runs for years: the capacity installed, the way zones are controlled, and how easily equipment can be serviced.'],
                ['text' => 'Green Means Ltd carries this through from assessment and design to supply, installation, commissioning, and ongoing maintenance.'],
            ],
        ],
    ],
